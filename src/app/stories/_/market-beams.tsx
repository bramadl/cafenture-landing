...
export const MarketBeams = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-[480px] sm:h-[640px] flex items-center justify-center gap-12 md:gap-[100px] lg:gap-[200px] rounded-[64px] bg-slate-50 border border-secondary-200 shadow overflow-hidden"
    >
